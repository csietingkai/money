...
public class MessageConstant {
	...
	public static final String EXCHANGE_RATE_TRADE = "Trade {0}({1}) to {2}({3}) with rate {4, number, #,###.####}";
	...
	public static final String ACCOUNT_GET_RECORDS_SUCCESS = "Get Account Records Success";
	...
	public static final String ACCOUNT_RECORD_UPDATE_SUCCESS = "Account Records Update Success";
