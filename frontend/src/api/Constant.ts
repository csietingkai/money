...
export const USER_STOCK_UPDATE_PATH: string = STOCK_API_PREFIX + '/updateRecord';
...
export const STOCK_GET_TRACKINGS_PATH: string = STOCK_API_PREFIX + '/getTrackings';
...
export const USER_FUND_UPDATE_PATH: string = FUND_API_PREFIX + '/updateRecord';
...
export const FUND_GET_TRACKINGS_PATH: string = FUND_API_PREFIX + '/getTrackings';
...
export const ACCOUNT_GET_RECORD_PATH: string = ACCOUNT_API_PREFIX + '/getRecord';
