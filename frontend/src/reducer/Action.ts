...
// account
export const SetAccountList = (payload: AccountVo[]): Action<AccountVo[]> => ({ type: SET_ACCOUNT_LIST, payload });
...
export const SetTrackingStocks = (payload: UserTrackingStockVo[]): Action<UserTrackingStockVo[]> => ({ type: SET_TRACKING_STOCKS, payload });
...
export const SetTrackingFunds = (payload: UserTrackingFundVo[]): Action<UserTrackingFundVo[]> => ({ type: SET_TRACKING_FUNDS, payload });
