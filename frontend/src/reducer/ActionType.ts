...
export const SET_STOCK_PREDICT_RESULT: string = 'SET_STOCK_PREDICT_RESULT';
...
export const SET_FUND_PREDICT_RESULT: string = 'SET_FUND_PREDICT_RESULT';
...
export const SET_ACCOUNT_RECORD_DELETABLE: string = 'SET_ACCOUNT_RECORD_DELETABLE';
...
export const SET_EXCHANGE_RATE_DEFAULT_FOREIGNER_CURRENCY: string = 'SET_EXCHANGE_RATE_DEFAULT_FOREIGNER_CURRENCY';
